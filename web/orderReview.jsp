<%-- 
    ...
    Created on : Apr 26, 2015, 11:28:53 PM
...
//                    String phonNumber = nvp.get("PHONENUM").toString(); // ' Payer's contact telephone number. Note:  PayPal returns a contact telephone number only if your Merchant account profile settings require that the buyer enter one. 
                    out.println(email);
                    out.println(payerStatus);
                    out.println(payerId);
                    out.println(cntryCode);
                    out.println(shipToName);
                    out.println(shipToStreet);
                    out.println(shipToCity);
                    out.println(shipToState);
                    out.println(shipToCntryCode);
                    out.println(shipToZip);
                    out.println(addressStatus);
                    /*
